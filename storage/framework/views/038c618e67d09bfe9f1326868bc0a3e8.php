...
<?php $__env->startSection('title', 'Kurikulum - SMAN 11 KUPANG'); ?>
        ...
        <div class="container mx-auto px-4 lg:px-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-12 shadow-xl hover:shadow-2xl transition-all group overflow-hidden relative">
                    ...
                    <i class="fa fa-file-pdf text-5xl text-<?php echo e($doc['color']); ?>-500 mb-8 block group-hover:scale-125 transition-transform duration-500"></i>
                    <h5 class="text-xl font-black text-navy uppercase mb-8 leading-tight"><?php echo e($doc['name']); ?></h5>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectKP\resources\views/kurikulum.blade.php ENDPATH**/ ?>