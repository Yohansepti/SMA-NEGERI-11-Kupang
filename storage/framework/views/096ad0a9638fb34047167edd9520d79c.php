...
<?php $__env->startSection('title', 'SMA NEGERI 11 KUPANG - Masa Depan Cerah Dimulai Di Sini'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container mx-auto px-4 lg:px-10 h-full flex items-center relative z-10">
            <div class="max-w-4xl text-left">
                ...
                <div class="flex flex-wrap gap-8">
                    <a href="<?php echo e(route('ppdb')); ?>" class="btn-edukate bg-primary text-white hover:bg-white hover:text-navy text-[13px] px-12 group/btn shadow-2xl shadow-primary/30">
                        Start Journey <i class="fa fa-arrow-right ml-3 transition-transform group-hover/btn:translate-x-2"></i>
                    </a>
                    <a href="<?php echo e(route('kontak')); ?>" class="btn-edukate border-2 border-white/20 text-white hover:bg-white hover:text-navy text-[13px] px-12 backdrop-blur-sm">
                        Contact Us
                    </a>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4 lg:px-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('profil.sejarah')); ?>" class="btn-edukate bg-navy text-white hover:bg-primary shadow-xl shadow-navy/20">
    ...
    <section class="py-40 bg-light relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 lg:px-10 relative z-10">
            ...
            <?php if($academics->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                <?php $__currentLoopData = $academics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $academic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-<?php echo e(($index % 3 === 2) ? 'navy' : 'white'); ?> group overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-700 border-b-[8px] border-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'white')); ?>">
                    <div class="relative h-72 overflow-hidden">
                        <?php if($academic->image): ?>
                        <img src="<?php echo e(asset('storage/' . $academic->image)); ?>" class="w-full h-full object-cover <?php echo e(($index % 3 === 2) ? 'grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100' : 'grayscale group-hover:grayscale-0'); ?> group-hover:scale-110 transition-all duration-1000" alt="<?php echo e($academic->title); ?>">
                        <?php else: ?>
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($academic->title)); ?>&background=2878eb&color=fff&size=500" class="w-full h-full object-cover <?php echo e(($index % 3 === 2) ? 'grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100' : 'grayscale group-hover:grayscale-0'); ?> group-hover:scale-110 transition-all duration-1000" alt="<?php echo e($academic->title); ?>">
                        <?php endif; ?>
                        <div class="absolute top-6 right-6 bg-<?php echo e(($index % 3 === 2) ? 'primary' : 'white'); ?> w-14 h-14 flex items-center justify-center text-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'white')); ?> text-xl font-black"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></div>
                    </div>
                    <div class="p-12">
                        <h4 class="text-2xl font-black text-<?php echo e(($index % 3 === 2) ? 'white' : 'navy'); ?> mb-6 uppercase tracking-tighter group-hover:text-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'primary')); ?> transition-colors"><?php echo e($academic->title); ?></h4>
                        <p class="text-sm leading-relaxed mb-10 font-medium <?php echo e(($index % 3 === 2) ? 'text-white/50' : ''); ?>"><?php echo e($academic->description ?? Str::limit($academic->content, 100)); ?></p>
                        <?php if($academic->type === 'fasilitas'): ?>
                        <a href="<?php echo e(route('akademik.fasilitas')); ?>" class="text-xs font-black uppercase tracking-[0.3em] text-<?php echo e(($index % 3 === 2) ? 'primary' : 'navy'); ?> border-b-2 border-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'primary')); ?>/20 hover:border-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'primary')); ?> transition-all pb-2">Explore Facility</a>
                        <?php elseif($academic->type === 'ekskul'): ?>
                        <a href="<?php echo e(route('akademik.ekskul')); ?>" class="text-xs font-black uppercase tracking-[0.3em] text-<?php echo e(($index % 3 === 2) ? 'primary' : 'navy'); ?> border-b-2 border-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'primary')); ?>/20 hover:border-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'primary')); ?> transition-all pb-2">View Activities</a>
                        <?php else: ?>
                        <a href="<?php echo e(route('kurikulum')); ?>" class="text-xs font-black uppercase tracking-[0.3em] text-<?php echo e(($index % 3 === 2) ? 'primary' : 'navy'); ?> border-b-2 border-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'primary')); ?>/20 hover:border-<?php echo e(($index % 3 === 0) ? 'primary' : (($index % 3 === 1) ? 'secondary' : 'primary')); ?> transition-all pb-2">See Curriculum</a>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <section class="py-40 bg-light relative overflow-hidden">
        <div class="container mx-auto px-4 lg:px-10">
            <div class="flex flex-col lg:flex-row justify-between items-end mb-24 gap-8">
                ...
                <a href="<?php echo e(route('pengumuman')); ?>" class="btn-edukate border-2 border-navy text-navy hover:bg-navy hover:text-white mb-2 shadow-xl shadow-navy/5">Lihat Semua Pengumuman</a>
            </div>

            <?php if($announcements->count() > 0): ?>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <!-- Highlight Announcement -->
                <?php $featured = $announcements->first(); ?>
                <div class="bg-navy p-12 lg:p-20 text-white relative overflow-hidden group border-b-[20px] border-<?php echo e($featured->priority === 'Urgent' ? 'secondary' : 'primary'); ?> shadow-2xl">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center space-x-4 mb-10">
                            <?php if($featured->priority === 'Urgent'): ?>
                            ...
                            <?php endif; ?>
                            <span class="text-white/40 text-[10px] font-black uppercase tracking-[0.2em]"><?php echo e($featured->created_at->format('d M Y')); ?></span>
                        </div>
                        <h3 class="text-3xl lg:text-4xl font-black uppercase tracking-tighter mb-8 leading-tight"><?php echo e($featured->title); ?></h3>
                        <p class="text-white/60 leading-relaxed font-medium mb-12 text-lg"><?php echo e(Str::limit($featured->content, 150)); ?></p>
                        <a href="<?php echo e(route('pengumuman')); ?>" class="text-xs font-black uppercase tracking-[0.4em] text-<?php echo e($featured->priority === 'Urgent' ? 'secondary' : 'primary'); ?> border-b-2 border-<?php echo e($featured->priority === 'Urgent' ? 'secondary' : 'primary'); ?>/20 hover:border-<?php echo e($featured->priority === 'Urgent' ? 'secondary' : 'primary'); ?> transition-all pb-2">Read Detail Announcement</a>
                    </div>
                </div>

                <!-- Small List -->
                <div class="space-y-8">
                    <?php $__currentLoopData = $announcements->skip(1)->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-10 border border-slate-200 group hover:border-primary transition-all duration-500">
                        <div class="flex items-center space-x-4 mb-4">
                            <span class="text-navy/30 text-[9px] font-black uppercase tracking-[0.2em]"><?php echo e($item->created_at->format('d M Y')); ?></span>
                            <?php if($item->priority === 'Urgent'): ?>
                            <span class="bg-secondary text-white text-[9px] font-black px-2 py-1 uppercase">Urgent</span>
                            <?php endif; ?>
                        </div>
                        <h4 class="text-xl font-black text-navy uppercase tracking-tighter group-hover:text-primary transition-colors leading-tight mb-4"><?php echo e($item->title); ?></h4>
                        <p class="text-sm text-text font-medium mb-6 line-clamp-2"><?php echo e(Str::limit($item->content, 100)); ?></p>
                        <a href="<?php echo e(route('pengumuman')); ?>" class="text-[10px] font-black uppercase tracking-widest text-navy border-b border-primary/20 hover:border-primary transition-all pb-1">Detail Info</a>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="group text-center">
                    <div class="mb-8 relative overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-700 shadow-2xl skew-x-1 group-hover:skew-x-0">
                        <?php if($person->image): ?>
                        <img src="<?php echo e(asset('storage/' . $person->image)); ?>" class="w-full aspect-square object-cover transform scale-110 group-hover:scale-100 transition-transform duration-1000" alt="<?php echo e($person->name); ?>">
                        <?php else: ?>
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($person->name)); ?>&background=120f2d&color=fff&size=500" class="w-full aspect-square object-cover transform scale-110 group-hover:scale-100 transition-transform duration-1000" alt="<?php echo e($person->name); ?>">
                        <?php endif; ?>
                    ...
                    <h5 class="text-xl font-black text-navy uppercase tracking-tighter mb-1"><?php echo e($person->name); ?></h5>
                    <p class="text-[10px] font-black uppercase tracking-[0.3em] text-primary"><?php echo e($person->role); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php else: ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectKP\resources\views/home.blade.php ENDPATH**/ ?>