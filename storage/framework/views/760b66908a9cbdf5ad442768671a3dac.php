...
<?php $__env->startSection('title', 'Berita & Informasi - SMAN 11 KUPANG'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="bg-white group overflow-hidden shadow-xl">
                    <div class="relative h-64 overflow-hidden">
                        <?php if($item->image): ?>
                        <img src="<?php echo e(asset('storage/' . $item->image)); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="<?php echo e($item->title); ?>">
                        <?php else: ?>
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($item->title)); ?>&background=2878eb&color=fff&size=500" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="<?php echo e($item->title); ?>">
                        <?php endif; ?>
                    ...
                    <div class="p-10 border border-t-0 border-slate-100">
                        <div class="flex items-center text-xs font-bold text-primary uppercase mb-6 space-x-4">
                            ...
                            <span><i class="fa fa-tag mr-1 text-secondary"></i> <?php echo e($item->category); ?></span>
                        </div>
                        <h4 class="text-xl font-black text-navy mb-8 leading-tight group-hover:text-primary transition-colors min-h-[56px]"><?php echo e($item->title); ?></h4>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectKP\resources\views/berita.blade.php ENDPATH**/ ?>