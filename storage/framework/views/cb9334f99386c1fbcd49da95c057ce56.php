...
<?php $__env->startSection('title', 'Penerimaan Siswa Baru (PPDB) - SMAN 11 KUPANG'); ?>
        ...
        <div class="container mx-auto px-4 lg:px-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-16">
                ...
                <div class="lg:col-span-1">
                    ...
                    <h2 class="text-4xl font-black text-navy uppercase tracking-tighter leading-tight mb-8">Pendaftaran Tahun Pelajaran <span class="text-primary italic"><?php echo e($ppdb->academic_year); ?></span></h2>
                ...
                <div class="lg:col-span-2">
                        ...
                        <div class="space-y-6">
                            ...
                            <?php $__currentLoopData = $requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="flex items-start bg-white p-6 shadow-sm group">
                                    <div class="w-10 h-10 bg-primary/10 flex items-center justify-center text-primary font-black mr-6 shrink-0 group-hover:bg-primary group-hover:text-white transition-colors"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></div>
                                    <p class="font-bold text-navy leading-relaxed"><?php echo e($req); ?></p>
                                </div>
                                <?php endif; ?>
                    ...
                    <div x-show="tab === 'jadwal'" x-transition class="bg-light p-10 lg:p-20 shadow-xl border-t-8 border-secondary">
                        ...
                        <div class="space-y-6">
                            <?php $__currentLoopData = $ppdb->schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-white p-8 shadow-sm border-l-4 border-secondary group hover:bg-secondary/5 transition-all">
                                    <div class="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-4">
                                        <h4 class="text-xl font-black text-navy uppercase tracking-tight group-hover:text-secondary transition-colors"><?php echo e($item['kegiatan']); ?></h4>
                                        <span class="bg-secondary text-white px-4 py-1 text-xs font-black w-fit uppercase tracking-widest whitespace-nowrap"><?php echo e($item['waktu']); ?></span>
                                    </div>
                    ...
                    <div x-show="tab === 'brosur'" x-transition class="bg-light p-10 lg:p-20 shadow-xl border-t-8 border-primary">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                            ...
                            <div class="bg-navy px-6 py-3 border-l-4 border-primary">
                                ...
                                <span class="text-[9px] text-primary font-black uppercase tracking-tighter"><?php echo e($ppdb->updated_at->format('d M Y')); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div class="group relative bg-white p-4 shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-slate-100 flex flex-col">
                                <div class="relative overflow-hidden aspect-[3/4] bg-slate-900 border border-slate-200">
                                    ...
                                    <?php if($isImgB): ?>
                                        <img src="<?php echo e(asset('storage/' . $ppdb->brochure)); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Brosur">
                                    <?php else: ?>
                                    ...
                                    <div class="absolute inset-0 bg-navy/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-8 text-center space-y-6">
                                        ...
                                        <div class="flex gap-3">
                                            <a href="<?php echo e(asset('storage/' . $ppdb->brochure)); ?>" target="_blank" class="w-12 h-12 bg-white text-navy flex items-center justify-center hover:bg-primary hover:text-white transition-all transform hover:scale-110">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                            <a href="<?php echo e(asset('storage/' . $ppdb->brochure)); ?>" download class="w-12 h-12 bg-primary text-white flex items-center justify-center hover:bg-white hover:text-navy transition-all transform hover:scale-110">
                                ...
                                <div class="pt-6 pb-2 text-center">
                                    ...
                                    <a href="<?php echo e(asset('storage/' . $ppdb->brochure)); ?>" download class="inline-flex items-center gap-3 text-[10px] font-black text-primary uppercase tracking-[0.2em] group-hover:translate-x-2 transition-transform">
                            ...
                            <div class="group relative bg-white p-4 shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-slate-100 flex flex-col">
                                <div class="relative overflow-hidden aspect-[3/4] bg-slate-900 border border-slate-200">
                                    ...
                                    <?php if($isImgG): ?>
                                        <img src="<?php echo e(asset('storage/' . $ppdb->guide)); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Panduan">
                                    <?php else: ?>
                                        <div class="w-full h-full flex flex-col items-center justify-center bg-navy text-white space-y-4">
                                    ...
                                    <div class="absolute inset-0 bg-navy/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-8 text-center space-y-6">
                                        ...
                                        <div class="flex gap-3">
                                            <a href="<?php echo e(asset('storage/' . $ppdb->guide)); ?>" target="_blank" class="w-12 h-12 bg-white text-navy flex items-center justify-center hover:bg-primary hover:text-white transition-all transform hover:scale-110">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                            <a href="<?php echo e(asset('storage/' . $ppdb->guide)); ?>" download class="w-12 h-12 bg-primary text-white flex items-center justify-center hover:bg-white hover:text-navy transition-all transform hover:scale-110">
                                                <i class="fa fa-download"></i>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="pt-6 pb-2 text-center">
                                    ...
                                    <a href="<?php echo e(asset('storage/' . $ppdb->guide)); ?>" download class="inline-flex items-center gap-3 text-[10px] font-black text-primary uppercase tracking-[0.2em] group-hover:translate-x-2 transition-transform">
                                        Download Sekarang <i class="fa fa-arrow-right"></i>
                                    </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectKP\resources\views/ppdb.blade.php ENDPATH**/ ?>