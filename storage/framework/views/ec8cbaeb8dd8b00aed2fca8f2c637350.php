...
<?php $__env->startSection('title', 'Visi & Misi - SMAN 11 KUPANG'); ?>
                ...
                <div class="lg:w-2/3">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="bg-white p-10 shadow-lg hover:shadow-2xl transition-all duration-500 border-b-4 border-transparent hover:border-primary group">
                            <div class="text-5xl font-black text-light group-hover:text-primary/20 transition-colors mb-4">0<?php echo e($index + 1); ?></div>
                            <p class="font-bold text-navy leading-relaxed text-lg"><?php echo e($mission); ?></p>
                        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectKP\resources\views/profil/visimisi.blade.php ENDPATH**/ ?>