...
<?php $__env->startSection('title', 'Sambutan Kepala Sekolah - SMAN 11 KUPANG'); ?>
        ...
        <div class="container mx-auto px-4 lg:px-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                ...
                <div class="relative">
                    ...
                    <img src="<?php echo e(asset('images/kepala-sekolah.jpg')); ?>" onerror="this.src='/images/home/home1.png'" class="relative z-10 w-full shadow-2xl grayscale hover:grayscale-0 transition-all duration-1000" alt="Kepala Sekolah">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectKP\resources\views/profil/sambutan.blade.php ENDPATH**/ ?>