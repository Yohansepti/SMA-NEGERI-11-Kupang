...
<?php $__env->startSection('title', 'Fasilitas Sekolah - SMAN 11 KUPANG'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div class="bg-white border border-light group hover:border-primary transition-all duration-500 overflow-hidden shadow-sm hover:shadow-2xl">
                    <div class="relative h-64 overflow-hidden">
                        <?php if($item->image): ?>
                        <img src="<?php echo e(asset('storage/' . $item->image)); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-700" alt="<?php echo e($item->title); ?>">
                        <?php else: ?>
                        <img src="<?php echo e(asset('images/home/home1.png')); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-700" alt="<?php echo e($item->title); ?>">
                        <?php endif; ?>
                    ...
                    <div class="p-10 relative">
                        ...
                        <h4 class="text-2xl font-black text-navy uppercase mb-4 transition-colors group-hover:text-primary"><?php echo e($item->title); ?></h4>
                        <p class="text-sm leading-relaxed text-text mb-6"><?php echo e($item->description); ?></p>
    ...
    <section class="py-20 bg-navy">
        <div class="container mx-auto px-4 lg:px-10 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <a href="<?php echo e(route('kontak')); ?>" class="btn-edukate border-2 border-primary text-primary hover:bg-primary hover:text-white px-12">Visit Our Campus</a>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectKP\resources\views/akademik/fasilitas.blade.php ENDPATH**/ ?>